...
/**
 * @author Michaël Niessen
 * @docs The point-in-polygon algorithm allows you to check if a point is
 * inside a polygon or outside of it. http://assemblysys.com
 * @copyright GNU General Public License v3.0
 * @author Uğur Korkmaz <korkmaz.uu@gmail.com>
 * @package UgurKorkmaz\Zelty\Polygon
 * 
 */
class Polygon
{
